  ...
  return (
    <>
      <style jsx>{`
        ...
        .roam1 {
          animation: roam1 15s ease-in-out infinite;
        }
        .roam2 {
          animation: roam2 18s ease-in-out infinite;
        }
        .roam3 {
          animation: roam3 20s ease-in-out infinite;
        }
        .roam4 {
          animation: roam4 22s ease-in-out infinite;
        }
      `}</style>
