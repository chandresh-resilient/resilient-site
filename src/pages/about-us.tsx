  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Discover the vision, mission, and people behind Resilient IT Services—your partner in low-code development and digital growth." />
        <meta property="og:title" content="About Us | Resilient IT Services" />
        <meta property="og:description" content="Meet the team and values that drive our innovative low-code solutions." />
