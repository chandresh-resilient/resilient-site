...
const CareerPage = () => {
  return (
    <>
      <Head>
        <title>Careers | Resilient IT Services</title>
        <meta
          name="description"
          content="Join our team of low-code experts and help shape the future of digital transformation."
        />
        <meta property="og:title" content="Careers | Resilient IT Services" />
        <meta
          property="og:description"
          content="Explore exciting career opportunities with us."
        />
        <meta
          property="og:image"
        ...
        <main className="bg-[#f9fafb] text-gray-800 py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl font-extrabold text-[#1a103d]">
                Join the Team, Shape the Future
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Be part of a passionate team delivering low-code innovation with
                Mendix, OutSystems, and beyond.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {jobs.map((job, idx) => (
                ...
                >
                  <div>
                    <h3 className="text-xl font-semibold text-[#1a103d] mb-2">
                      {job.title}
                    </h3>
            ...
            <section className="mt-24 grid md:grid-cols-2 gap-10 items-center">
              ...
              />
              <div>
                <h2 className="text-3xl font-bold text-[#1a103d] mb-4">
                  Why work with us?
                </h2>
            ...
            <div className="mt-24 text-center">
              ...
              <p className="text-gray-600 mb-6">
                We’re always open to new talent. Send us your resume, and we’ll
                get in touch!
              </p>
              <a
                href="mailto:info@resilientitservices.com"
