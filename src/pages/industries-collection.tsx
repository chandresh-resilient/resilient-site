...
export default function IndustriesSection() {
  ...
  return (
    <div className="relative bg-white px-6 py-12">
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center text-black">Industries We Serve</h2>
          ...
          {industries.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white z-10">
                ...
                <a href='#'className="mt-3 flex items-center gap-1 text-sm font-medium tracking-wide">READ MORE  <ArrowRight className="w-4 h-4" /> </a>
              </div>
            </div>
          ))}
        </div>
