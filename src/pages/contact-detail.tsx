...
const contactDetail = () => {
  return (
    <>
      <Head>
        <title>Contact Us | Resilient IT Services</title>
        <meta
          name="description"
          content="Ready to build something amazing? Contact Resilient IT Services for expert low-code development and digital transformation solutions."
        />
        <meta
          property="og:title"
          content="Contact Us | Resilient IT Services"
        />
        <meta
